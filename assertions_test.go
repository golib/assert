...
func TestImplementsWrapper(t *testing.T) {
	...
	if assert.Implements((*AssertionTesterInterface)(nil), new(AssertionTesterUnconformingObject)) {
...
func TestIsTypeWrapper(t *testing.T) {
	...
	if assert.IsType(new(AssertionTesterConformingObject), new(AssertionTesterUnconformingObject)) {
...
func TestNotErrorWrapper(t *testing.T) {
	...
	assert.True(mockAssert.NotError(err), "NotError should return True for nil arg")

	// now set an error
	err = errors.New("Some error")

	assert.False(mockAssert.NotError(err), "NotError with error should return False")
...
func TestEqualErrorsWrapper(t *testing.T) {
	...
	// start with a nil error
	var err error
	assert.False(mockAssert.EqualErrors(err, nil),
		"EqualError should return false for nil arg")

	// now set an error
	err = errors.New("some error")
	assert.False(mockAssert.EqualErrors(err, errors.New("Not some error")),
		"EqualError should return false for different error string")
	assert.True(mockAssert.EqualErrors(err, errors.New("some error")),
		"EqualError should return true")
}
...
func TestJSONEqWrapper_EqualSONString(t *testing.T) {
	assert := New(new(testing.T))
	if !assert.EqualJSON(`{"hello": "world", "foo": "bar"}`, `{"hello": "world", "foo": "bar"}`) {
...
func TestJSONEqWrapper_EquivalentButNotEqual(t *testing.T) {
	assert := New(new(testing.T))
	if !assert.EqualJSON(`{"hello": "world", "foo": "bar"}`, `{"foo": "bar", "hello": "world"}`) {
		t.Error("JSONEq should return true")
	}
...
func TestJSONEqWrapper_Array(t *testing.T) {
	assert := New(new(testing.T))
	if !assert.EqualJSON(`["foo", {"hello": "world", "nested": "hash"}]`, `["foo", {"nested": "hash", "hello": "world"}]`) {
		t.Error("JSONEq should return true")
	}
...
func TestJSONEqWrapper_HashAndArrayNotEquivalent(t *testing.T) {
	assert := New(new(testing.T))
	if assert.EqualJSON(`["foo", {"hello": "world", "nested": "hash"}]`, `{"foo": "bar", {"nested": "hash", "hello": "world"}}`) {
...
func TestJSONEqWrapper_HashesNotEquivalent(t *testing.T) {
	assert := New(new(testing.T))
	if assert.EqualJSON(`{"foo": "bar"}`, `{"foo": "bar", "hello": "world"}`) {
		t.Error("JSONEq should return false")
	}
}
...
func TestJSONEqWrapper_ActualIsNotJSON(t *testing.T) {
	assert := New(new(testing.T))
	if assert.EqualJSON(`{"foo": "bar"}`, "Not JSON") {
		t.Error("JSONEq should return false")
	}
}
...
func TestJSONEqWrapper_ExpectedIsNotJSON(t *testing.T) {
	assert := New(new(testing.T))
	if assert.EqualJSON("Not JSON", `{"foo": "bar", "hello": "world"}`) {
		t.Error("JSONEq should return false")
	}
}
...
func TestJSONEqWrapper_ExpectedAndActualNotJSON(t *testing.T) {
	assert := New(new(testing.T))
	if assert.EqualJSON("Not JSON", "Not JSON") {
		t.Error("JSONEq should return false")
	}
}
...
func TestJSONEqWrapper_ArraysOfDifferentOrder(t *testing.T) {
	assert := New(new(testing.T))
	if assert.EqualJSON(`["foo", {"hello": "world", "nested": "hash"}]`, `[{ "hello": "world", "nested": "hash"}, "foo"]`) {
		t.Error("JSONEq should return false")
	}
}
